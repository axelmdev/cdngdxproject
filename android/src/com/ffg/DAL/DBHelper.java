...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<String> GetAllCreationQueries(){
        ...
        String sentenceCharacterTableQuery = "CREATE TABLE "+SENTENCELINKTABLE_NAME+" ("+COL_IDSENT+" INTEGER NOT NULL ,"+ COL_IDCHAR +"INTEGER NOT NULL";
        sentenceCharacterTableQuery += ",CONSTRAINT dit_PK PRIMARY KEY ("+COL_IDSENT+","+ COL_IDCHAR +")";
        sentenceCharacterTableQuery += ",CONSTRAINT dit_Sentence_FK FOREIGN KEY ("+COL_IDSENT+") REFERENCES Sentence("+SentenceDAO.COL_ID+")";
        sentenceCharacterTableQuery += ",CONSTRAINT dit_Character0_FK FOREIGN KEY ("+ COL_IDCHAR +") REFERENCES Character("+CharacterDAO.COL_ID+")";
        allQueries.add(sentenceCharacterTableQuery);

        String skillActiveCharacterTableQuery = "CREATE TABLE "+SKILLLINKTABLE_NAME+" ("+COL_IDSKILL+" INTEGER NOT NULL ,"+ COL_IDCHAR +"INTEGER NOT NULL";
        sentenceCharacterTableQuery += ",CONSTRAINT lance_PK PRIMARY KEY ("+COL_IDSKILL+","+ COL_IDCHAR +")";
        sentenceCharacterTableQuery += ",CONSTRAINT lance_Skill_FK FOREIGN KEY ("+COL_IDSKILL+") REFERENCES Skill("+SkillDAO.COL_ID+")";
        sentenceCharacterTableQuery += ",CONSTRAINT lance_ActiveCharacter0_FK FOREIGN KEY ("+ COL_IDCHAR +") REFERENCES ActiveCharacter("+ActiveCharacterDAO.COL_ID+")";
        allQueries.add(sentenceCharacterTableQuery);
